...
#
# krumkach.tcl: Tcl script for re-creating project 'krumkach'
#
# Generated by Vivado on Sun Feb 26 00:27:46 PST 2023
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/files/constraints.xdc"]"\
 "[file normalize "$origin_dir/files/Main_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/uart_rx"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/glitcher_ip_0.2"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/krumkach"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/uart_rx"] [file normalize "$origin_dir/glitcher_ip_0.2"]" $obj
...
set file "[file normalize ${origin_dir}/files/constraints.xdc]"
...
proc cr_bd_Main { parentCell } {
  ...
  user.org:user:glitcher_ip:0.2\
  xilinx.com:ip:processing_system7:5.5\
  xilinx.com:ip:proc_sys_reset:5.0\
  user.org:user:uart_rx:1.0\
  ...
  # Create ports
  set CUSTOM [ create_bd_port -dir O -from 1 -to 0 -type data CUSTOM ]
  set GLITCH [ create_bd_port -dir O GLITCH ]
  set LED_RUN [ create_bd_port -dir O LED_RUN ]
  set TARGET_NRST [ create_bd_port -dir O TARGET_NRST ]
  set TRIGGER_EVENT [ create_bd_port -dir O TRIGGER_EVENT ]
  set TRIGGER_EXT [ create_bd_port -dir I TRIGGER_EXT ]
  set UART_RX [ create_bd_port -dir I UART_RX ]
  set UART_TX [ create_bd_port -dir O UART_TX ]

  # Create instance: custom_ctrl, and set properties
  set custom_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 custom_ctrl ]
  ...
  # Create instance: glitcher, and set properties
  set glitcher [ create_bd_cell -type ip -vlnv user.org:user:glitcher_ip:0.2 glitcher ]
...
\
  ...
  set uart_rx_0 [ create_bd_cell -type ip -vlnv user.org:user:uart_rx:1.0 uart_rx_0 ]
  ...
  set_property CONFIG.C_BAUDRATE {115200} $uartlite
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins glitcher/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins custom_ctrl/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins uartlite/S_AXI]

  # Create port connections
  connect_bd_net -net TRIGGER_IN_1 [get_bd_ports TRIGGER_EXT] [get_bd_pins glitcher/TRIGGER_IN]
  connect_bd_net -net UART_RX_IN_1 [get_bd_ports UART_RX] [get_bd_pins uart_rx_0/i_Rx_Serial] [get_bd_pins uartlite/rx]
  connect_bd_net -net custom_ctrl_gpio_io_o [get_bd_ports CUSTOM] [get_bd_pins custom_ctrl/gpio_io_o]
  connect_bd_net -net glitcher_ip_0_EVENT_OUT [get_bd_ports TRIGGER_EVENT] [get_bd_pins glitcher/EVENT_OUT]
  connect_bd_net -net glitcher_ip_0_RUN_OUT [get_bd_ports LED_RUN] [get_bd_pins glitcher/RUN_OUT]
  connect_bd_net -net glitcher_ip_0_TARGET_NRST_OUT [get_bd_ports TARGET_NRST] [get_bd_pins glitcher/TARGET_NRST_OUT]
  connect_bd_net -net glitcher_ip_0_TRIGGER_OUT [get_bd_ports GLITCH] [get_bd_pins glitcher/TRIGGER_OUT]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins custom_ctrl/s_axi_aclk] [get_bd_pins glitcher/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins uart_rx_0/i_Clock] [get_bd_pins uartlite/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins custom_ctrl/s_axi_aresetn] [get_bd_pins glitcher/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins uart_rx_0/i_nRst] [get_bd_pins uartlite/s_axi_aresetn]
  connect_bd_net -net uart_rx_0_o_Rx_Byte [get_bd_pins glitcher/RX] [get_bd_pins uart_rx_0/o_Rx_Byte]
  connect_bd_net -net uart_rx_0_o_Rx_DV [get_bd_pins glitcher/RX_READY] [get_bd_pins uart_rx_0/o_Rx_DV]
  connect_bd_net -net uartlite_interrupt [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins uartlite/interrupt]
  connect_bd_net -net uartlite_tx [get_bd_ports UART_TX] [get_bd_pins uartlite/tx]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs glitcher/S_AXI/S_AXI_reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs custom_ctrl/S_AXI/Reg] -force
  assign_bd_address -offset 0x42C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs uartlite/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-550,-162",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1190 -y 60 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1190 -y 80 -defaultsOSRD
preplace port port-id_GLITCH -pg 1 -lvl 4 -x 1190 -y 240 -defaultsOSRD
preplace port port-id_LED_RUN -pg 1 -lvl 4 -x 1190 -y 300 -defaultsOSRD
preplace port port-id_TARGET_NRST -pg 1 -lvl 4 -x 1190 -y 280 -defaultsOSRD
preplace port port-id_TRIGGER_EVENT -pg 1 -lvl 4 -x 1190 -y 260 -defaultsOSRD
preplace port port-id_TRIGGER_EXT -pg 1 -lvl 0 -x -20 -y 400 -defaultsOSRD
preplace port port-id_UART_RX -pg 1 -lvl 0 -x -20 -y 620 -defaultsOSRD
preplace port port-id_UART_TX -pg 1 -lvl 4 -x 1190 -y 670 -defaultsOSRD
preplace portBus CUSTOM -pg 1 -lvl 4 -x 1190 -y 450 -defaultsOSRD
preplace inst glitcher -pg 1 -lvl 3 -x 1000 -y 270 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 110 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 640 -y 240 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 230 -y 510 -defaultsOSRD
preplace inst custom_ctrl -pg 1 -lvl 3 -x 1000 -y 440 -defaultsOSRD
preplace inst uart_rx_0 -pg 1 -lvl 2 -x 640 -y 490 -defaultsOSRD
preplace inst uartlite -pg 1 -lvl 3 -x 1000 -y 660 -defaultsOSRD
preplace netloc TRIGGER_IN_1 1 0 3 0J -10 NJ -10 850J
preplace netloc UART_RX_IN_1 1 0 4 NJ 620 460 570 NJ 570 1150
preplace netloc glitcher_ip_0_EVENT_OUT 1 3 1 NJ 260
preplace netloc glitcher_ip_0_RUN_OUT 1 3 1 NJ 300
preplace netloc glitcher_ip_0_TARGET_NRST_OUT 1 3 1 NJ 280
preplace netloc glitcher_ip_0_TRIGGER_OUT 1 3 1 NJ 240
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 220 440 40 820
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 230 430
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 450 50 800
preplace netloc uart_rx_0_o_Rx_Byte 1 2 1 830 240n
preplace netloc uart_rx_0_o_Rx_DV 1 2 1 840 260n
preplace netloc uartlite_interrupt 1 0 4 10 0 NJ 0 NJ 0 1160
preplace netloc uartlite_tx 1 3 1 NJ 670
preplace netloc custom_ctrl_gpio_io_o 1 3 1 N 450
...
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 220
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 810 240n
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 790 260n
levelinfo -pg 1 -20 230 640 1000 1190
pagesize -pg 1 -db -bbox -sgen -170 -20 1360 750
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse Main.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/krumkach.gen/sources_1/bd/Main/hdl/Main_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/../files/Main_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/krumkach.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/krumkach.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/krumkach.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
