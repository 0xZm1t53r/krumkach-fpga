...
#
# Generated by Vivado on Sat Feb 25 00:53:42 PST 2023
...
set orig_proj_dir "[file normalize "$origin_dir/krumkach-fpga"]"
...
proc cr_bd_Main { parentCell } {
  ...
  set POWER_ON [ create_bd_port -dir O -from 0 -to 0 POWER_ON ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  # Create instance: target_power_ctrl, and set properties
  set target_power_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 target_power_ctrl ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins target_power_ctrl/S_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports POWER_ON] [get_bd_pins target_power_ctrl/gpio_io_o]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins glitcher/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins target_power_ctrl/s_axi_aclk] [get_bd_pins uart_rx_0/i_Clock] [get_bd_pins uartlite/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins glitcher/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins target_power_ctrl/s_axi_aresetn] [get_bd_pins uart_rx_0/i_nRst] [get_bd_pins uartlite/s_axi_aresetn]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs target_power_ctrl/S_AXI/Reg] -force
...
preplace port port-id_UART_RX -pg 1 -lvl 0 -x -10 -y 620 -defaultsOSRD
preplace port port-id_TRIGGER_EXT -pg 1 -lvl 0 -x -10 -y 400 -defaultsOSRD
preplace port port-id_LED_RUN -pg 1 -lvl 4 -x 1180 -y 300 -defaultsOSRD
preplace port port-id_TARGET_NRST -pg 1 -lvl 4 -x 1180 -y 280 -defaultsOSRD
preplace port port-id_GLITCH -pg 1 -lvl 4 -x 1180 -y 240 -defaultsOSRD
preplace port port-id_TRIGGER_EVENT -pg 1 -lvl 4 -x 1180 -y 260 -defaultsOSRD
preplace port port-id_UART_TX -pg 1 -lvl 4 -x 1180 -y 670 -defaultsOSRD
preplace portBus POWER_ON -pg 1 -lvl 4 -x 1180 -y 450 -defaultsOSRD
...
preplace inst target_power_ctrl -pg 1 -lvl 3 -x 1000 -y 440 -defaultsOSRD
...
preplace netloc TRIGGER_IN_1 1 0 3 10J 230 450J 40 850J
preplace netloc UART_RX_IN_1 1 0 4 NJ 620 490 570 NJ 570 1150
preplace netloc axi_gpio_0_gpio_io_o 1 3 1 NJ 450
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 400 460 50 820
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 410 430
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 480 70 800
preplace netloc uart_rx_0_o_Rx_Byte 1 2 1 830 240n
preplace netloc uart_rx_0_o_Rx_DV 1 2 1 840 260n
preplace netloc uartlite_interrupt 1 0 4 30 220 440J 30 NJ 30 1160
...
levelinfo -pg 1 -10 230 640 1000 1180
pagesize -pg 1 -db -bbox -sgen -160 0 1350 750
"
}
